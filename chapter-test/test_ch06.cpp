...
void test_parsing_and_serialization(const char* hex_str_in, const size_t expected_cmds_size, char expected_str_outs[][4096]) {
  ...
  cr_expect(ret_val == 1);
  cr_expect(my_script.get_cmds().size() == expected_cmds_size);
...
Test(ch06_test_suite, test_script_parsing_and_serialization1) {    
  ...
  test_parsing_and_serialization(hex_str_in, expected_cmds_size, expected_str_outs);
}
...
Test(ch06_test_suite, test_script_parsing_and_serialization3_OP_PUSHDATA1) {
  ...
  char hex_str_in[] = "fd1f0100483045022100990eabdb96bbcdb961864c781a6868dee3d0dada85e0a4d818c61fe16e885d8c02200ae8744e2833b46194fbe5e54aa9b"
    ...
    "311071407541be554ae";
  const size_t expected_cmds_size = 4;
  char expected_str_outs[expected_cmds_size][4096] = {
    "00",
