...
void test_base58() {
  ...
  cout << endl;
  cout << "Expected result: 2NEpo7TZRRrLZSi2U" << endl;
  free(output);
  ...
  for (int i = 0; i < output_len; ++i) { cout << output[i]; }
  cout << endl;
  cout << "Expected result: USm3fpXnKG5EUBx2ndxBDMPVciP5hGey2Jh4NDv6gmeo1LkMeiKrLJUUBk6Z" << endl;
  free(output);
  ...
  for (int i = 0; i < output_len; ++i) { cout << output[i]; }
  cout << endl;
  cout << "Expected result: 9MA8fRQrT4u8Zj8ZRd6MAiiyaxb2Y1CMpvVkHQu5hVM6" << endl;
  free(output);
  ...
  for (int i = 0; i < output_len; ++i) { cout << output[i]; }
  cout << endl;
  cout << "Expected result: 4fE3H2E6XMp4SsxtwinF7w9a34ooUrwWe4WsW1458Pd" << endl;
  free(output);
  ...
  for (int i = 0; i < output_len; ++i) { cout << output[i]; }
  cout << endl;
  cout << "Expected result: EQJsjkd6JaGwxrjEhfeqPenqHwrBmPQZjJGNSCHBkcF7" << endl;
  free(output);
  ...
  for (int i = 0; i < output_len; ++i) { cout << output[i]; }
  cout << endl;
  cout << "Expected result: 111233QC4 (questionable)" << endl;
  free(output);
}
