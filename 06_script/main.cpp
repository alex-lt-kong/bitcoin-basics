...
Test(ch06_test_suite, test_script_parser1) {
  size_t input_len;
...
Test(ch06_test_suite, test_script_parser2) {
...
Test(ch06_test_suite, test_script_parser3) {
  // This test case is manually constructed from transaction:
  ...
  char* hex_input = (char*)hex_string_to_bytes(
    "fd1f0100483045022100990eabdb96bbcdb961864c781a6868dee3d0dada85e0a4d818c61fe16e885d8c02200ae8744e2833b46194fbe5e54aa9b"
...
Test(ch06_test_suite, test_script_parser4) {
  // This test case is manually constructed from transaction:
